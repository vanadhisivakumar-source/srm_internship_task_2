...
function toggleProfileMenu() {
    ...
    const menu = createTopDropdown('profileMenu', '<div class="menu-header">Account</div><a class="menu-item" href="profile-update.php">Profile</a><a class="menu-item" href="logout.php">Logout</a>');
    if (!menu.classList.contains('hidden')) {
        menu.classList.add('hidden');
        return;
    }
